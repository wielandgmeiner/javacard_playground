/*  From https://github.com/LedgerHQ/ledger-javacard/blob/master/src/com/ledger/wallet/Ripemd160.java
*******************************************************************************
...
public class Ripemd160 {
    public static void hash32(byte[] buffer, short offset, byte[] target, short targetOffset, byte[] scratch, short scratchOffset)
    {
      ...
      for (i = 0; i < 16; i++) {
        ...
        switch(i) {
            case 0: X0HIGH = high; X0LOW = low; break;
            case 1: X1HIGH = high; X1LOW = low; break;
            case 2: X2HIGH = high; X2LOW = low; break;
            case 3: X3HIGH = high; X3LOW = low; break;
            case 4: X4HIGH = high; X4LOW = low; break;
            case 5: X5HIGH = high; X5LOW = low; break;
            case 6: X6HIGH = high; X6LOW = low; break;
            case 7: X7HIGH = high; X7LOW = low; break;
            case 8: X8HIGH = high; X8LOW = low; break;
            case 9: X9HIGH = high; X9LOW = low; break;
            case 10: X10HIGH = high; X10LOW = low; break;
            case 11: X11HIGH = high; X11LOW = low; break;
            case 12: X12HIGH = high; X12LOW = low; break;
            case 13: X13HIGH = high; X13LOW = low; break;
            case 14: X14HIGH = high; X14LOW = low; break;
            case 15: X15HIGH = high; X15LOW = low; break;
        }
      }
      ...
      for (i = 0; i < 80; i++)
        {
          ...
          rotMsk = mask[(short)10]; rotH = DHIGH; rotL = DLOW; rotSh = (short) (rotMsk & ((short) (rotH >>> ((short)(16-(short)10))))); rotSl = (short) (rotMsk & ((short) (rotL >>> ((short)(16-(short)10))))); DHIGH = (short) ((rotH<<(short)10) | rotSl); DLOW = (short) ((rotL<<(short)10) | rotSh);
          CHIGH = BHIGH; CLOW = BLOW;
          BHIGH = THIGH; BLOW = TLOW;
          rotMsk = mask[sLOW]; rotH = BHIGH; rotL = BLOW; rotSh = (short) (rotMsk & ((short) (rotH >>> ((short)(16-sLOW))))); rotSl = (short) (rotMsk & ((short) (rotL >>> ((short)(16-sLOW))))); BHIGH = (short) ((rotH<<sLOW) | rotSl); BLOW = (short) ((rotL<<sLOW) | rotSh);
          ...
          rotMsk = mask[(short)10]; rotH = DpHIGH; rotL = DpLOW; rotSh = (short) (rotMsk & ((short) (rotH >>> ((short)(16-(short)10))))); rotSl = (short) (rotMsk & ((short) (rotL >>> ((short)(16-(short)10))))); DpHIGH = (short) ((rotH<<(short)10) | rotSl); DpLOW = (short) ((rotL<<(short)10) | rotSh);
          CpHIGH = BpHIGH; CpLOW = BpLOW;
          BpHIGH = THIGH; BpLOW = TLOW;
          rotMsk = mask[sLOW]; rotH = BpHIGH; rotL = BpLOW; rotSh = (short) (rotMsk & ((short) (rotH >>> ((short)(16-sLOW))))); rotSl = (short) (rotMsk & ((short) (rotL >>> ((short)(16-sLOW))))); BpHIGH = (short) ((rotH<<sLOW) | rotSl); BpLOW = (short) ((rotL<<sLOW) | rotSh);
