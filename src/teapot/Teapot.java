...
public class Teapot extends Applet
{
   ...
   public void process(APDU apdu)
   {
      ...
      {
         // The APDU format can be "B0 11 P1 P2 Lc Data Le", 
         // such as "B0110000" or "B01101020311223300".
      case INS_DEMO_TMP1:
         SendData(apdu);
         break;
         // The APDU format can be "B0 12 P1 P2 Lc Data Le",
         // such as "B0125566" or "B012000002112200".
      case INS_DEMO_TMP2:
         // Set 0x5555 into the 'buf' array, the offset is 0.
         Util.setShort(buf, (short)0, (short)0x5555);
         // Send the first 2 bytes data in 'buf',
         // the hex of JCRE sending data is "55 55 90 00".
