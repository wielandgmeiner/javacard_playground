...
/**
 * A simple applet that stores data up to 255 bytes on the card. 
 * <p>
...
public class TeapotApplet extends Applet{
    ...
    /** Max storage capacity. We use 255 to fit in one APDU command. */
    ...
    private void StoreData(APDU apdu){
        ...
        // if MAX_DATA_LENGTH is 255 it will be always ok.
